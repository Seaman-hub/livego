...
[![Test](https://github.com/Seaman-hub/livego/workflows/Test/badge.svg)](https://github.com/Seaman-hub/livego/actions?query=workflow%3ATest)
[![Release](https://github.com/Seaman-hub/livego/workflows/Release/badge.svg)](https://github.com/Seaman-hub/livego/actions?query=workflow%3ARelease)
...
## Installation
After directly downloading the compiled [binary file](https://github.com/Seaman-hub/livego/releases), execute it on the command line.

#### Boot from Docker
Run `docker run -p 1935:1935 -p 7001:7001 -p 7002:7002 -p 8090:8090 -d Seaman-hub/livego` to start

#### Compile from source
1. Download the source code `git clone https://github.com/Seaman-hub/livego.git`
...
### [Use with flv.js](https://github.com/Seaman-hub/blog/issues/3)
